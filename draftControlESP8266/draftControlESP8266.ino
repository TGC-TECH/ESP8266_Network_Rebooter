...
<body>
<center>
<h1>WiFi Relay Control: </h1><br>
Ciclk to turn <a href="ledOn">LED ON</a><br>
Ciclk to turn <a href="ledOff">LED OFF</a><br>
Ciclk to turn <a href="buzzOff">Buzz OFF</a><br>
clik to turn <a href="buzzon">Buzz ON</a><br>
...
void handlebuzzon() { 
 Serial.println("Buzz On Page");
 digitalWrite(D0,HIGH); //LED off
  digitalWrite(16,HIGH); //LED off

 server.send(200, "text/html", "BUZZ is ON"); //Send ADC value only to client ajax request
}
//==============================================================
//                  SETUP
//==============================================================
